...
Understand typical architecture styles , workloads , and best practices .
...
Your team or organization might have other design principles, such as sustainability and responsible engineering , that you can use to evaluate your workload.
...
The catalog of cloud design patterns in Azure addresses specific challenges in distributed systems. For AI workloads that include multiple autonomous agents, see AI agent orchestration patterns . It includes specialized coordination approaches that complement traditional design patterns by addressing the unique challenges of orchestrating intelligent, autonomous components.
## Make informed technology choices
...
Compute refers to the hosting model for the computing resources, or application platform, that your applications run on. For more information, see Choose a compute service . See specialized guidance, like Choose an Azure container service and Azure hybrid options , for specific application platforms.
Data stores include databases and storage for files, caches, logs, and anything else that an application might persist to storage. For more information, see Understand data store models and Review your storage options .
Messaging technologies enable asynchronous messaging between components of the system. For more information, see Asynchronous messaging options .
AI technologies solve problems that are computationally complex to implement in traditional application code. For more information, see Choose an AI services technology .
...
For additional migration guidance, see the Azure Migration Hub .
## Next step
Architecture styles
## Feedback
