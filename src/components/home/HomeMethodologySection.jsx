...
function MethodologyCard({ step }) {
  return (
    <motion.article
      className="flex min-h-0 w-full flex-col rounded-xl border border-[rgba(72,72,72,0.18)] bg-[rgba(19,19,19,0.65)] px-6 pb-10 pt-9 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_12px_40px_rgba(0,0,0,0.35)] backdrop-blur-sm md:min-h-[320px] md:px-7 md:pb-11 md:pt-10 lg:text-left"
      whileHover={{
        y: -2,
        borderColor: 'rgba(175, 162, 255, 0.14)',
        boxShadow:
          'inset 0 1px 0 rgba(255,255,255,0.04), 0 20px 48px -24px rgba(0,0,0,0.45), 0 0 0 1px rgba(116,89,247,0.08)',
