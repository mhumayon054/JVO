  ...
  return (
    <section className="w-full max-w-[1280px]" aria-labelledby="case-studies-void-cta-heading">
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-[640px] text-[17px] font-normal leading-[1.5em] text-[#ABABAB] sm:text-[18px] sm:leading-[1.55em]">
          Our team of elite engineers is ready to bridge the gap between AI hype and production-grade reality.
        </p>
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:mt-12 sm:flex-row sm:flex-wrap sm:gap-5">
          <Link
            to="/contact"
            className="inline-flex min-h-[56px] w-full max-w-[360px] items-center justify-center rounded-[8px] px-8 text-[17px] font-bold leading-[1.35] text-[#0E0E0E] transition-opacity hover:opacity-95 sm:w-auto sm:max-w-none sm:min-h-0 sm:py-5 sm:text-[18px]"
            style={{
          ...
          <Link
            to="/services"
            className="inline-flex min-h-[56px] w-full max-w-[360px] items-center justify-center rounded-[8px] border border-[rgba(255,255,255,0.22)] bg-transparent px-8 text-[17px] font-bold leading-[1.35] text-white transition-colors hover:border-white/40 hover:bg-white/[0.04] sm:w-auto sm:max-w-none sm:min-h-0 sm:py-5 sm:text-[18px]"
